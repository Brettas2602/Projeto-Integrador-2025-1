...
export default function Form() {
    ...
    const [ficha, setFicha] = useState({
        ...
        dados_anamnese: {
            ...
            hormonio_menopausa: false,
            fez_radioterapia: false,
            ultima_menstruacao: null,
            sangramento_relacoes: false,
            sangramento_menopausa: false
        },
        exame_clinico: {
            inspecao_colo: "",
            sinais_dst: false,
            ...
            <form className="flex flex-col gap-10 mb-12">
                ...
                <section className="flex flex-col gap-5">
                    ...
                    <div className="flex gap-5">
                        ...
                        <Input title="DDD" name="ddd" value={paciente.ddd || ""} onChange={handlePacienteChange} className="w-1/3" />
